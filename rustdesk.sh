...
curl -L -o "rustdesk-1.4.3-x86_64.deb" -C - "https://github.com/rustdesk/rustdesk/releases/download/1.4.3/rustdesk-1.4.3-x86_64.deb"
apt install ./rustdesk-1.4.3-x86_64.deb -y
apt install -f -y
apt install ./rustdesk-1.4.3-x86_64.deb -y
apt autoremove -y
